...
if __name__ == "__main__":
    ...
    val_dataloader = DataLoader(VideoDataset(dataset_path='data/ucf101', images_path='val', clip_len=16), batch_size=16, num_workers=2)
    test_dataloader = DataLoader(VideoDataset(dataset_path='data/ucf101', images_path='test', clip_len=16), batch_size=16, num_workers=2)
